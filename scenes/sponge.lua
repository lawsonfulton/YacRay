...
tex_test = gr.fancy_material({0.740063, 0.742313, 0.733934}, {0.4, 0.4, 0.4}, 500.0, 0.8,1.0,0.0,3)
tex_test:set_texture_map("textures/wood_floor.png")

sponge_mat = gr.fancy_material({0.4, 0.7, 0.2533934}, {0.6, 0.6, 0.6}, 4000.0, 0.8,1.0,0.0,5)
...
bally = -0.5
ballz = 0
sponge = gr.menger_sponge("sponge", 5)
sponge:translate(ballx,bally,ballz)
sponge:rotate('y',-20)
sponge:scale(1,1,1)
sponge:set_material(sponge_mat)
scene:add_child(sponge)
...
sqlight = gr.rect_light({2,5, -10}, 3, 3, light_color, {1,0,0}, 5)
...
-- 	  {0.2, 0.2, 0.2}, {light1, light2})
gr.render(scene,
	  'sponge.png', 1920, 1080, 2,
	  {-0.1, 0.1, -2}, {ballx + 0.07, bally - 0.2 , ballz}, {0, 1, 0}, 50,
