...
mirror = gr.fancy_material({0,0,0}, {1, 1, 1}, 50000000, 1.0, 1.0, 0.0, 1)
...
white_cornell_shiny = gr.fancy_material({0.740063/2, 0.742313/2, 0.733934/2}, {1, 1, 1}, 40000000, 0.6,1.0,0.0,1)
